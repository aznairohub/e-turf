        ...
        <nav id="sidebar" class="">
			...
			<div class="nalika-profile">
				<div class="profile-dtl">
					<a href="#"><img src="/admin/img/mn.png" alt="" /></a>
            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            <a href="/mhome"><i class="icon nalika-home icon-wrap"></i>
								            <span class="mini-click-non">Dashboard Manager</span></a>  
                        </li>
                        <li>
                            <a href="/mlogin" aria-expanded="false"><i class="icon nalika-forms icon-wrap"></i> <span class="mini-click-non">Login</span></a>
                        </li>
                        <li>
                            <a href="/viewturf" aria-expanded="false"><i class="icon-dribbble"></i> <span class="mini-click-non">View Turf Details</span></a>
                        </li>
                        <li>
                            <a href="/viewbk" aria-expanded="false"><i class="icon-male"></i> <span class="mini-click-non">View Bookings</span></a>
                        </li>
                        <li>
                            <a href="/vfeed" aria-expanded="false"><i class="icon nalika-forms icon-wrap"></i> <span class="mini-click-non">View Feedbacks</span></a>
                        </li>
                        <li>
                            <a href="/logout" aria-expanded="false"><i class="icon-off"></i></i> <span class="mini-click-non">Logout</span></a> 
                        </li>
                        </li>
                    </ul>
                </nav>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                      ...
                                      <li><a href="/mprofile"><span class="icon nalika-user author-log-ic"></span> My Profile</a>
                                      </li>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                      ...
                                      <div class="breadcomb-wp"> 
                                        ...
                                        <div class="breadcomb-ctn">
                                          <h2>Dashboard</h2>
                                          <p>Welcome to  <span class="bread-ntd">Manager Page</span></p>
                                        </div> 
                                      </br>    
										                </div>
                                  </div>
